...
; build      : release: nasm -f elf64 -I ../../../includes waitforkeypress.asm -o waitforkeypress.o
;                       ld -m elf_x86_64 -pie --dynamic-linker /lib64/ld-linux-x86-64.so.2 -o waitforkeypress waitforkeypress.o
;               debug : nasm -f elf64 -I ../../../includes -g -Fdwarf -o waitforkeypress.debug.o waitforkeypress.asm
;                       ld -m elf_x86_64 -pie --dynamic-linker /lib64/ld-linux-x86-64.so.2 -o waitforkeypress.debug *.o
